...
![IV Chart](outputs/plots/iv_chart.png)
...
![Model Validation](outputs/plots/model_validation.png)
...
![EL by Grade](outputs/plots/el_by_grade.png)
...
![Vintage Forecast](outputs/plots/vintage_forecast.png)
...
![EL Heatmap](outputs/plots/el_heatmap.png)
...
├── README.md
│
├── data/                       ← Place Freddie Mac files here (not tracked)
